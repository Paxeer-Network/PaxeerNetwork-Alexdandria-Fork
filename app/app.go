...
import (
	...
	"github.com/paxeer/paxeer/v20/encoding"
	"github.com/paxeer/paxeer/v20/x/evm/core/vm"

	// unnamed import of statik for swagger UI support
	_ "github.com/paxeer/paxeer/v20/client/docs/statik"
	"github.com/paxeer/paxeer/v20/utils"

	evmostypes "github.com/paxeer/paxeer/v20/types"
	"github.com/paxeer/paxeer/v20/x/epochs"
	epochskeeper "github.com/paxeer/paxeer/v20/x/epochs/keeper"
	epochstypes "github.com/paxeer/paxeer/v20/x/epochs/types"
	"github.com/paxeer/paxeer/v20/x/evm"
	evmkeeper "github.com/paxeer/paxeer/v20/x/evm/keeper"
	evmtypes "github.com/paxeer/paxeer/v20/x/evm/types"
	inflation "github.com/paxeer/paxeer/v20/x/inflation/v1"
	inflationkeeper "github.com/paxeer/paxeer/v20/x/inflation/v1/keeper"
	inflationtypes "github.com/paxeer/paxeer/v20/x/inflation/v1/types"

	"github.com/paxeer/paxeer/v20/app/ante"
	ethante "github.com/paxeer/paxeer/v20/app/ante/evm"
	"github.com/paxeer/paxeer/v20/app/post"
	v20 "github.com/paxeer/paxeer/v20/app/upgrades/v20"
	srvflags "github.com/paxeer/paxeer/v20/server/flags"
	"github.com/paxeer/paxeer/v20/x/erc20"
	erc20keeper "github.com/paxeer/paxeer/v20/x/erc20/keeper"
	erc20types "github.com/paxeer/paxeer/v20/x/erc20/types"
	"github.com/paxeer/paxeer/v20/x/feemarket"
	feemarketkeeper "github.com/paxeer/paxeer/v20/x/feemarket/keeper"
	feemarkettypes "github.com/paxeer/paxeer/v20/x/feemarket/types"
	"github.com/paxeer/paxeer/v20/x/staking"
	stakingkeeper "github.com/paxeer/paxeer/v20/x/staking/keeper"
	"github.com/paxeer/paxeer/v20/x/vesting"
	vestingkeeper "github.com/paxeer/paxeer/v20/x/vesting/keeper"
	vestingtypes "github.com/paxeer/paxeer/v20/x/vesting/types"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/paxeer/paxeer/v20/x/ibc/transfer"
	transferkeeper "github.com/paxeer/paxeer/v20/x/ibc/transfer/keeper"

	memiavlstore "github.com/crypto-org-chain/cronos/store"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/paxeer/paxeer/v20/x/evm/core/tracers/js"
	_ "github.com/paxeer/paxeer/v20/x/evm/core/tracers/native"
)

func init() {
	var err error
	DefaultNodeHome, err = clienthelpers.GetNodeHomeDirectory(".hyperpaxd")
	if err != nil {
		panic(err)
	}

	// manually update the power reduction by replacing micro (u) -> atto (a) hpx
