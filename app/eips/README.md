...
where `vm` is the package `"github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/v20/x/evm/core/vm"`.
...
[`x/evm/`](https://github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/tree/main/x/evm) folder
of **evmOS**.
