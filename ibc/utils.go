...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/utils"
...
func GetTransferSenderRecipient(data transfertypes.FungibleTokenPacketData) (
	...
	// and change the bech32 human readable prefix (HRP) of the sender to `paxeer`
	...
	// and change the bech32 human readable prefix (HRP) of the recipient to `paxeer`
