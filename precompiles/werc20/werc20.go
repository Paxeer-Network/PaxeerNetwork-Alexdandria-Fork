...
import (
	...
	erc20 "github.com/Paxeer-Network/hyperpaxeer-os/precompiles/erc20"
...
func (p Precompile) RequiredGas(input []byte) uint64 {
	// TODO: these values were obtained from Remix using the WHPX9.sol.
	// We should execute the transactions from Paxeer testnet
