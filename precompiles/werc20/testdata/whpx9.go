...
// LoadWHPX9Contract load the WHPX9 contract from the json representation of
// the Solidity contract.
func LoadWHPX9Contract() (evmtypes.CompiledContract, error) {
	return contractutils.LoadContractFromJSONFile("WHPX9.json")
}
