...
import (
	...
	"github.com/paxeer/paxeer/v20/contracts"
	auth "github.com/paxeer/paxeer/v20/precompiles/authorization"
	"github.com/paxeer/paxeer/v20/precompiles/erc20"
	"github.com/paxeer/paxeer/v20/precompiles/erc20/testdata"
	...
	"github.com/paxeer/paxeer/v20/testutil/integration/evmos/utils"
	utiltx "github.com/paxeer/paxeer/v20/testutil/tx"
	...
	Context("basic functionality -", func() {
		...
		When("querying allowance", func() {
			...
			When("querying the allowance for the own address", func() {
				...
				//
				// For reference see this comment: https://github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/pull/2088#discussion_r1407646217
