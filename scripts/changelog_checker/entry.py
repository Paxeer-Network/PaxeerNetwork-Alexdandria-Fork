...
def check_link(link: str, pr_number: int) -> Tuple[str, List[str]]:
    ...
    if not link.startswith("https://github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/pull/"):
        fixed = f"https://github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/pull/{pr_number}"
