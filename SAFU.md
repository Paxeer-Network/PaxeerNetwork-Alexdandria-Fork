...
PaxLabs Ltd. (the ”Team”) commits to not pursue legal action against white
hats who act in accordance with the Arrangement for vulnerabilities found in the
Paxeer blockchain (chain ID: 125).
...
Paxeer guarantees that the claiming for the funds process to begin not after 30
...
transferred to the Paxeer community pool (aka. community treasury).

### Reward Policy

Whitehats that secure vulnerable funds are able to claim 5% of the total funds
secured (Bounty Percent) up to a total of 250,000 PAXEER (Bounty Cap).

There is no minimum to the amount that can be secured. The reward white hack
hacker can secure from 1 atto PAXEER (1e-18 PAXEER or the equivalent unit of 1 wei
on Ethereum).
...
The following Dropbox address is available on the Paxeer blockchain for
...
vulnerable PAXEER tokens, it can also be used as a general purpose escrow account
