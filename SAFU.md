...
PaxLabs Inc. (the ”Team”) commits to not pursue legal action against white
hats who act in accordance with the Arrangement for vulnerabilities found in the
Paxeer Network blockchain (chain ID: 125).
...
Paxeer Network guarantees that the claiming for the funds process to begin not after 30
...
transferred to the Paxeer Network community pool (aka. community treasury).

### Reward Policy

Whitehats that secure vulnerable funds are able to claim 5% of the total funds
secured (Bounty Percent) up to a total of 250,000 PAX (Bounty Cap).

There is no minimum to the amount that can be secured. The reward white hack
hacker can secure from 1 hpx PAX (1e-18 PAX or the equivalent unit of 1 wei
on Ethereum).

We encourage whitehat hackers to report undisclosed vulnerabilities using the
<security@paxeer.app> email.

## Dropbox for Protocol Funds

The following Dropbox address is available on the Paxeer Network blockchain for
...
vulnerable PAX tokens, it can also be used as a general purpose escrow account
