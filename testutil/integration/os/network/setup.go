...
import (
	...
	exampleapp "github.com/Paxeer-Network/hyperpaxeer-os/example_chain"
	paxtypes "github.com/Paxeer-Network/hyperpaxeer-os/types"
	erc20types "github.com/Paxeer-Network/hyperpaxeer-os/x/erc20/types"
	evmtypes "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/types"
	feemarkettypes "github.com/Paxeer-Network/hyperpaxeer-os/x/feemarket/types"
)

// genSetupFn is the type for the module genesis setup functions
type genSetupFn func(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, customGenesis interface{}) (paxtypes.GenesisState, error)
...
var genesisSetupFunctions = map[string]genSetupFn{
	...
	consensustypes.ModuleName: func(_ *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, _ interface{}) (paxtypes.GenesisState, error) {
...
func genStateSetter[T proto.Message](moduleName string) genSetupFn {
	return func(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, customGenesis interface{}) (paxtypes.GenesisState, error) {
		moduleGenesis, ok := customGenesis.(T)
		if !ok {
			return nil, fmt.Errorf("invalid type %T for %s module genesis state", customGenesis, moduleName)
		}

		genesisState[moduleName] = paxeerApp.AppCodec().MustMarshalJSON(moduleGenesis)
		return genesisState, nil
	}
}
...
// createTestingApp creates an paxeer app
...
func setDefaultStakingGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams StakingCustomGenesisState) paxtypes.GenesisState {
	// Set staking params
	...
	genesisState[stakingtypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(stakingGenesis)
	return genesisState
}
...
func setDefaultBankGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams BankCustomGenesisState) paxtypes.GenesisState {
	...
	genesisState[banktypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(&updatedBankGen)
	return genesisState
}
...
func setDefaultSlashingGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams SlashingCustomGenesisState) paxtypes.GenesisState {
	...
	genesisState[slashingtypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(slashingGen)
	return genesisState
}

// setBankGenesisState updates the bank genesis state with custom genesis state
func setBankGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, customGenesis interface{}) (paxtypes.GenesisState, error) {
	...
	paxeerApp.AppCodec().MustUnmarshalJSON(genesisState[banktypes.ModuleName], bankGen)
	...
	genesisState[banktypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(bankGen)
	return genesisState, nil
}
...
func setDefaultAuthGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, genAccs []authtypes.GenesisAccount) paxtypes.GenesisState {
	defaultAuthGen := authtypes.NewGenesisState(authtypes.DefaultParams(), genAccs)
	genesisState[authtypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(defaultAuthGen)
	return genesisState
}

// setAuthGenesisState updates the bank genesis state with custom genesis state
func setAuthGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, customGenesis interface{}) (paxtypes.GenesisState, error) {
	...
	paxeerApp.AppCodec().MustUnmarshalJSON(genesisState[authtypes.ModuleName], authGen)
	...
	genesisState[authtypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(authGen)
	return genesisState, nil
}
...
func setDefaultGovGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams GovCustomGenesisState) paxtypes.GenesisState {
	...
	genesisState[govtypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(govGen)
	return genesisState
}
...
func setDefaultFeeMarketGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams FeeMarketCustomGenesisState) paxtypes.GenesisState {
	fmGen := feemarkettypes.DefaultGenesisState()
	fmGen.Params.BaseFee = overwriteParams.baseFee
	genesisState[feemarkettypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(fmGen)
	return genesisState
}
...
func setDefaultMintGenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState, overwriteParams MintCustomGenesisState) paxtypes.GenesisState {
	...
	genesisState[minttypes.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(mintGen)
	return genesisState
}

func setDefaultErc20GenesisState(paxeerApp *exampleapp.ExampleChain, genesisState paxtypes.GenesisState) paxtypes.GenesisState {
	// NOTE: here we are using the setup from the example chain
	erc20Gen := exampleapp.NewErc20GenesisState()
	updatedErc20Gen := updateErc20GenesisStateForChainID(paxeerApp.ChainID(), *erc20Gen)

	genesisState[erc20types.ModuleName] = paxeerApp.AppCodec().MustMarshalJSON(&updatedErc20Gen)
	return genesisState
}

// defaultAuthGenesisState sets the default genesis state
// for the testing setup
func newDefaultGenesisState(paxeerApp *exampleapp.ExampleChain, params defaultGenesisParams) paxtypes.GenesisState {
	genesisState := paxeerApp.DefaultGenesis()

	genesisState = setDefaultAuthGenesisState(paxeerApp, genesisState, params.genAccounts)
	genesisState = setDefaultStakingGenesisState(paxeerApp, genesisState, params.staking)
	genesisState = setDefaultBankGenesisState(paxeerApp, genesisState, params.bank)
	genesisState = setDefaultGovGenesisState(paxeerApp, genesisState, params.gov)
	genesisState = setDefaultFeeMarketGenesisState(paxeerApp, genesisState, params.feemarket)
	genesisState = setDefaultSlashingGenesisState(paxeerApp, genesisState, params.slashing)
	genesisState = setDefaultMintGenesisState(paxeerApp, genesisState, params.mint)
	genesisState = setDefaultErc20GenesisState(paxeerApp, genesisState)
...
func customizeGenesis(paxeerApp *exampleapp.ExampleChain, customGen CustomGenesisState, genesisState paxtypes.GenesisState) (paxtypes.GenesisState, error) {
	var err error
	for mod, modGenState := range customGen {
		if fn, found := genesisSetupFunctions[mod]; found {
			genesisState, err = fn(paxeerApp, genesisState, modGenState)
			if err != nil {
