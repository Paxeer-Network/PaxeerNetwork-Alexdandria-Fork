...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/testutil/network"

	paxeernetwork "github.com/Paxeer-Network/hyperpaxeer-os/testutil/network"
)
...
func (s *IntegrationTestSuite) SetupSuite() {
	...
	var err error
	cfg := paxeernetwork.DefaultConfig()
