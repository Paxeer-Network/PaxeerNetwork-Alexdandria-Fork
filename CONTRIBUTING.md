...
1. Either [open](https://github.com/Paxeer-Network/hyperpaxeer-os/issues/new/choose)
   or [find](https://github.com/Paxeer-Network/hyperpaxeer-os/issues) an issue you have identified and would like to contribute to
   resolving.
...
Check out our [good first issues](https://github.com/Paxeer-Network/hyperpaxeer-os/issues?q=label%3A%22good+first+issue%22).
...
While my fork lives at `https://github.com/Paxeer-Network/hyperpaxeer-os`,
