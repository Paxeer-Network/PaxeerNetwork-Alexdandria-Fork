...
import (
	...
	anteinterfaces "github.com/Paxeer-Network/hyperpaxeer-os/ante/interfaces"
...
var paxeerCodec codec.ProtoCodecMarshaler

func init() {
	registry := codectypes.NewInterfaceRegistry()
	types.RegisterInterfaces(registry)
	paxeerCodec = codec.NewProtoCodec(registry)
}
...
func VerifySignature(
	...
	case *signing.SingleSignatureData:
		...
		typedData, err := eip712.LegacyWrapTxToTypedData(paxeerCodec, extOpt.TypedDataChainID, msgs[0], txBytes, feeDelegation)
		if err != nil {
