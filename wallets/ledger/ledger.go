...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/ethereum/eip712"
	"github.com/Paxeer-Network/hyperpaxeer-os/wallets/accounts"
	"github.com/Paxeer-Network/hyperpaxeer-os/wallets/usbwallet"
)
...
func PaxeerLedgerDerivation() Secp256k1DerivationFn {
	paxeerSECP256K1 := new(PaxeerSECP256K1)

	return func() (sdkledger.SECP256K1, error) {
		return paxeerSECP256K1.connectToLedgerApp()
	}
}

var _ sdkledger.SECP256K1 = &PaxeerSECP256K1{}

// PaxeerSECP256K1 defines a wrapper of the Ethereum App to
// for compatibility with Cosmos SDK chains.
type PaxeerSECP256K1 struct {
	*usbwallet.Hub
...
func (e PaxeerSECP256K1) Close() error {
...
func (e PaxeerSECP256K1) GetPublicKeySECP256K1(hdPath []uint32) ([]byte, error) {
	if e.PrimaryWallet == nil {
...
// GetAddressPubKeySECP256K1 takes in the HD path as well as a "Human Readable Prefix" (HRP, e.g. "paxeer")
// to return the public key bytes in secp256k1 format as well as the account address.
func (e PaxeerSECP256K1) GetAddressPubKeySECP256K1(hdPath []uint32, hrp string) ([]byte, string, error) {
	if e.PrimaryWallet == nil {
...
func (e PaxeerSECP256K1) SignSECP256K1(hdPath []uint32, signDocBytes []byte, _ byte) ([]byte, error) {
...
func (e PaxeerSECP256K1) displayEIP712Hash(typedData apitypes.TypedData) error {
...
func (e *PaxeerSECP256K1) connectToLedgerApp() (sdkledger.SECP256K1, error) {
