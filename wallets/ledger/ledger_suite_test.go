...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/wallets/ledger"
	"github.com/Paxeer-Network/hyperpaxeer-os/wallets/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupTest() {
	...
	suite.ledger = ledger.PaxeerSECP256K1{Hub: hub, PrimaryWallet: mockWallet}
}
	...
	tmp := whitespaceRegex.ReplaceAllString(fmt.Sprintf(
		`{
			...
			"msgs":[{
				...
				"value":{
					"amount":[{"amount":"150","denom":"atom"}],
					"from_address":"pax10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky",
					"to_address":"pax1fx944mzagwdhx0wz7k9tfztc8g3lkfk6rrgv6l"
				}
			}],
			"sequence":"6"
...
func (suite *LedgerTestSuite) getMockTxProtobuf() []byte {
	...
	msg := bankTypes.NewMsgSend(
		sdk.MustAccAddressFromBech32("pax1r5sckdd808qvg7p8d0auaw896zcluqfduvr8nf"),
		sdk.MustAccAddressFromBech32("pax10t8ca2w09ykd6ph0agdz5stvgau47whhlfe3l4"),
		[]sdk.Coin{
			{
				Denom:  "atom",
