...
Paxeer Network Non-Commercial License 1.0 (ENCL-1.0) was created by PaxLabs Inc.
(Paxeer Network) to provide a mutually beneficial balance between the user benefits of
...
**Q: What is Paxeer Network Non-Commercial License 1.0 (ENCL-1.0)?**
...
blockchain consensus. The initial Designated Blockchains shall be the Paxeer Network
blockchains, identified by chain identifiers 9000 (testing network or testnet)
and 9001 (main network or mainnet).

Paxeer Network is currently building Paxeer Network, the commercial name of the software associated with the Paxeer Network repository,
to help developers to create their own EVM-compatible blockchain network with custom parameters.
You may use Paxeer Network for your commercial project, subject to the applicable Paxeer Network license.
For more information about Paxeer Network, check out the Paxeer Network Manifesto.
...
open source, such as empowering all non-Paxeer Network software developers to be part of
...
**A:** You may contact the legal department of licensor: os@Paxeer Network.org. They
...
**Q: What if I am currently using Paxeer Network code commercially in my business/project?**

**A:**You are allowed to continue using the code from older versions (<v13.0.0)
of Paxeer Network repository under LGPL 3.0, however, you must obtain a commercial permit
...
"Required Notice: Copyright PaxLabs Inc. (Paxeer Network)(https://github.com/Paxeer-Network)"
...
Paxeer Network does not claim it to be one. The legal phrasing of the ENCL 1.0 has been
...
planned to be included on Ethermint are instead going to be part of Paxeer Network.
For more information on the Paxeer Network, check out the Paxeer Network Manifesto.
...
permit from Paxeer Network for the ENCL code, but we will not grant rights to release the
...
**A:** First, a big thank you! You can contribute the code to the official Paxeer Network
