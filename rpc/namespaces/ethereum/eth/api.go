...
// The Ethereum API allows applications to connect to an node of any HyperPaxeer based blockchain.
...
// GasPrice returns the current gas price based on HyperPaxeer's gas price oracle.
