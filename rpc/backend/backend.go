...
type EVMBackend interface {
	...
	GetTxByEthHash(txHash common.Hash) (*paxtypes.TxResult, error)
	GetTxByTxIndex(height int64, txIndex uint) (*paxtypes.TxResult, error)
...
func NewBackend(
	...
	chainID, err := paxtypes.ParseChainID(clientCtx.ChainID)
	if err != nil {
		panic(err)
	}
