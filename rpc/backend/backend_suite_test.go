...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/encoding"
	"github.com/Paxeer-Network/hyperpaxeer-os/indexer"
	"github.com/Paxeer-Network/hyperpaxeer-os/rpc/backend/mocks"
...
func (suite *BackendTestSuite) SetupTest() {
	...
	nodeDirName := "node"
	clientDir := filepath.Join(baseDir, nodeDirName, "paxeercli")
