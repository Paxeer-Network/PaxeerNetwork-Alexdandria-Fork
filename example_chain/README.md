# Example HyperPaxeer Chain

This directory contains an example chain that uses the HyperPaxeer modules.
...
This chain implementation is used to demonstrate the integration of HyperPaxeer
