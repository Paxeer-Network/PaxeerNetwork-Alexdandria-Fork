...
func SubmitProposal(
	ctx sdk.Context,
	appPaxeer *exampleapp.ExampleChain,
	...
	res, err := DeliverTx(ctx, appPaxeer, pk, nil, msg)
	if err != nil {
		return id, err
	}
...
func Delegate(
	...
	return DeliverTx(ctx, appPaxeer, priv, nil, delegateMsg)
}
...
func Vote(
	...
	return DeliverTx(ctx, appPaxeer, priv, nil, voteMsg)
}
