...
// EthSetup initializes a new HyperPaxeer application. A Nop logger is set in ExampleChain.
func EthSetup(isCheckTx bool, chainID string, patchGenesis func(*exampleapp.ExampleChain, paxtypes.GenesisState) paxtypes.GenesisState) *exampleapp.ExampleChain {
...
func EthSetupWithDB(isCheckTx bool, chainID string, patchGenesis func(*exampleapp.ExampleChain, paxtypes.GenesisState) paxtypes.GenesisState, db dbm.DB) *exampleapp.ExampleChain {
...
func NewTestGenesisState(app *exampleapp.ExampleChain) paxtypes.GenesisState {
	privVal := mock.NewPV()
...
func genesisStateWithValSet(codec codec.Codec, genesisState paxtypes.GenesisState,
	valSet *cmtypes.ValidatorSet, genAccs []authtypes.GenesisAccount,
	balances ...banktypes.Balance,
) paxtypes.GenesisState {
