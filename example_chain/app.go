...
import (
	...
	paxante "github.com/Paxeer-Network/hyperpaxeer-os/ante"
	paxeerevmante "github.com/Paxeer-Network/hyperpaxeer-os/ante/evm"
	paxeerencoding "github.com/Paxeer-Network/hyperpaxeer-os/encoding"
	chainante "github.com/Paxeer-Network/hyperpaxeer-os/example_chain/ante"
	srvflags "github.com/Paxeer-Network/hyperpaxeer-os/server/flags"
	paxtypes "github.com/Paxeer-Network/hyperpaxeer-os/types"
	paxutils "github.com/Paxeer-Network/hyperpaxeer-os/utils"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/erc20"
	erc20keeper "github.com/Paxeer-Network/hyperpaxeer-os/x/erc20/keeper"
	erc20types "github.com/Paxeer-Network/hyperpaxeer-os/x/erc20/types"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/evm"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/evm/core/vm"
	evmkeeper "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/keeper"
	evmtypes "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/types"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/feemarket"
	feemarketkeeper "github.com/Paxeer-Network/hyperpaxeer-os/x/feemarket/keeper"
	feemarkettypes "github.com/Paxeer-Network/hyperpaxeer-os/x/feemarket/types"
	"github.com/spf13/cast"

	// NOTE: override ICS20 keeper to support IBC transfers of ERC20 tokens
	"github.com/Paxeer-Network/hyperpaxeer-os/x/ibc/transfer"
	transferkeeper "github.com/Paxeer-Network/hyperpaxeer-os/x/ibc/transfer/keeper"

	// Force-load the tracer engines to trigger registration due to Go-Ethereum v1.10.15 changes
	_ "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/core/tracers/js"
	_ "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/core/tracers/native"
)

func init() {
	// manually update the power reduction by replacing micro (u) -> atto (a) paxeer
	sdk.DefaultPowerReduction = paxtypes.AttoPowerReduction
...
func NewExampleApp(
	...
	paxeerAppOptions PaxeerOptionsFn,
	baseAppOptions ...func(*baseapp.BaseApp),
) *ExampleChain {
	encodingConfig := paxeerencoding.MakeConfig()
	...
	// initialize the HyperPaxeer application configuration
	if err := paxeerAppOptions(bApp.ChainID()); err != nil {
		panic(err)
	}
	...
	*/
	...
	// NOTE: we are adding all available HyperPaxeer EVM extensions.
...
func (app *ExampleChain) setAnteHandler(txConfig client.TxConfig, maxGasWanted uint64) {
	options := chainante.HandlerOptions{
		...
		ExtensionOptionChecker: paxtypes.HasDynamicFeeExtensionOption,
		EvmKeeper:              app.EVMKeeper,
		FeegrantKeeper:         app.FeeGrantKeeper,
		IBCKeeper:              app.IBCKeeper,
		FeeMarketKeeper:        app.FeeMarketKeeper,
		SignModeHandler:        txConfig.SignModeHandler(),
		SigGasConsumer:         paxante.SigVerificationGasConsumer,
		MaxTxGasWanted:         maxGasWanted,
		TxFeeChecker:           paxeerevmante.NewDynamicFeeChecker(app.FeeMarketKeeper),
	}
...
func (app *ExampleChain) InitChainer(ctx sdk.Context, req *abci.RequestInitChain) (*abci.ResponseInitChain, error) {
	var genesisState paxtypes.GenesisState
...
func (a *ExampleChain) DefaultGenesis() map[string]json.RawMessage {
	...
	// which is the base denomination of the chain (i.e. the WHPX contract)
...
//   - HyperPaxeer' available static precompiled contracts
func BlockedAddresses() map[string]bool {
	...
	for _, precompile := range blockedPrecompilesHex {
		blockedAddrs[paxutils.EthHexToCosmosAddr(precompile).String()] = true
	}
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	// TODO: do we need a keytable? copied from Paxeer repo
