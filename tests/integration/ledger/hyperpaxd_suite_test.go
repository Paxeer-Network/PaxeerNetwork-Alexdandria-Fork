...
import (
	...
	clientkeys "github.com/Paxeer-Network/hyperpaxeer-os/client/keys"
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/tests/integration/ledger/mocks"
...
func (suite *LedgerTestSuite) SetupPaxeerApp() {
...
func (suite *LedgerTestSuite) paxeerAddKeyCmd() *cobra.Command {
...
func (suite *LedgerTestSuite) MockKeyringOption() keyring.Option {
	return func(options *keyring.Options) {
		options.SupportedAlgos = paxkeyring.SupportedAlgorithms
		options.SupportedAlgosLedger = paxkeyring.SupportedAlgorithmsLedger
		options.LedgerDerivation = func() (cosmosledger.SECP256K1, error) { return suite.ledger, nil }
		options.LedgerCreateKey = paxkeyring.CreatePubkey
		options.LedgerAppName = paxkeyring.AppName
		options.LedgerSigSkipDERConv = paxkeyring.SkipDERConversion
	}
}
