...
for running end-to-end tests on Paxeer Network.
It is used for testing chain upgrades,
as it allows for initializing multiple Paxeer Network chains with different versions.
...
This package is decoupled from depending on the Paxeer Network codebase.
It initializes the chains for testing via Docker.  
As a result, the test suite may provide the
desired Paxeer Network version to Docker containers during the initialization.
This design allows for the opportunity of testing chain upgrades
by providing an older Paxeer Network version to the container,
...
```log
ok  	github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/v9/tests/e2e	174.137s.
```
...
Error:  Received unexpected error:
        ...
        main.appCreator.newApp({{{0x3399b40, 0xc000ec1db8}, {0x33ac0f8, 0xc00...
            github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/v10/cmd/evmosd/root.go:243 +0x2ca
        ...
        main.main()
            github.com/Paxeer-Network/PaxeerNetwork-Alexdandria-Fork/v10/cmd/evmosd/main.go:20 +0x45
