...
import (
	...
	evmosclient "github.com/paxeer/paxeer/v20/client"
	"github.com/paxeer/paxeer/v20/client/block"
	"github.com/paxeer/paxeer/v20/client/debug"
	evmosserver "github.com/paxeer/paxeer/v20/server"
	servercfg "github.com/paxeer/paxeer/v20/server/config"
	srvflags "github.com/paxeer/paxeer/v20/server/flags"

	"github.com/paxeer/paxeer/v20/app"
	evmoskr "github.com/paxeer/paxeer/v20/crypto/keyring"
)

const EnvPrefix = "HYPERPAX"

type emptyAppOptions struct{}

func (ao emptyAppOptions) Get(_ string) interface{} { return nil }

// NewRootCmd creates a new root command for hyperpaxd. It is called once in the
// main function.
