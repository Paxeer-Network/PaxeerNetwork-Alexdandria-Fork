...
import (
	...
	"github.com/paxeer/paxeer/v20/crypto/hd"
	evmoskr "github.com/paxeer/paxeer/v20/crypto/keyring"
	"github.com/paxeer/paxeer/v20/server/config"
	srvflags "github.com/paxeer/paxeer/v20/server/flags"
	"github.com/paxeer/paxeer/v20/testutil/network"
...
Example:
	hyperpaxd testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
...
Example:
	hyperpaxd testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
