...
WORKDIR /go/src/github.com/paxeer/hyperpaxeer
...
COPY --from=build-env /go/src/github.com/paxeer/hyperpaxeer/build/hyperpaxd /usr/bin/hyperpaxd
...
RUN apk add --no-cache \
    ...
    lz4 \
    rclone \
    && addgroup -g 1000 hyperpax \
    && adduser -S -h /home/hyperpax -D hyperpax -u 1000 -G hyperpax

USER 1000
WORKDIR /home/hyperpax
