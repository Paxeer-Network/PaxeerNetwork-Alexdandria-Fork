...
func TestGetAccAddressFromBech32(t *testing.T) {
	...
	config.SetBech32PrefixForAccount("paxeer", "paxeerpub")
	...
	testCases := []struct {
		...
		{
			"paxeer address",
			"pax1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			"pax1qql8ag4cluz6r4dz28p3w00dnc9w8ueuafmxps",
			false,
		},
		{
...
func TestPaxeerCoinDenom(t *testing.T) {
	testCases := []struct {
		name     string
		denom    string
		expError bool
...
func TestAddressConversion(t *testing.T) {
	...
	bech32 := "pax10jmp6sgh4cc6zt3e8gw05wavvejgr5pwjnpcky"
