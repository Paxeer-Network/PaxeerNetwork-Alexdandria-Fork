...
import (
	...
	cryptocodec "github.com/Paxeer-Network/hyperpaxeer-os/crypto/codec"
	enccodec "github.com/Paxeer-Network/hyperpaxeer-os/encoding/codec"
...
func TestKeyring(t *testing.T) {
	...
	kr, err := keyring.New("paxeer", keyring.BackendTest, dir, mockIn, TestCodec, EthSecp256k1Option())
	...
	info, mnemonic, err := kr.NewMnemonic("foo", keyring.English, paxtypes.BIP44HDPath, keyring.DefaultBIP39Passphrase, EthSecp256k1)
	require.NoError(t, err)
...
func TestDerivation(t *testing.T) {
	bz, err := EthSecp256k1.Derive()(mnemonic, keyring.DefaultBIP39Passphrase, paxtypes.BIP44HDPath)
	require.NoError(t, err)
	require.NotEmpty(t, bz)
	...
	path := MustParseDerivationPath(paxtypes.BIP44HDPath)
	account, err := wallet.Derive(path, false)
	require.NoError(t, err)
	...
	// Equality of HyperPaxeer implementation
	...
	// Equality of Eth and HyperPaxeer implementation
	...
	// Inequality of wrong derivation path of Eth and HyperPaxeer implementation
