...
func (suite *ParamsTestSuite) TestParamsValidate() {
	testCases := []struct {
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.WHPXContractMainnet})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WHPXContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WHPXContractTestnet, testconstants.WHPXContractMainnet}, []string{})
			},
			false,
			"",
		},
		{
			...
			// order of creation shouldn't matter since it should be sorted when defining new param
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WHPXContractMainnet, testconstants.WHPXContractTestnet}, []string{})
			},
			false,
			"",
		},
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WHPXContractMainnet}, []string{testconstants.WHPXContractMainnet})
			},
			true,
		...
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{testconstants.WHPXContractMainnet, testconstants.WHPXContractMainnet}, []string{})
			},
			true,
			"duplicate precompile",
		},
		{
			...
			func() types.Params {
				return types.NewParams(true, []string{}, []string{testconstants.WHPXContractMainnet, testconstants.WHPXContractMainnet})
			},
			true,
			"duplicate precompile",
		},
		...
		},
		{
			...
			func() types.Params {
				...
				params.NativePrecompiles = []string{testconstants.WHPXContractTestnet, testconstants.WHPXContractMainnet}
				return params
			},
			true,
...
func (suite *ParamsTestSuite) TestIsNativePrecompile() {
	testCases := []struct {
	...
	}{
		{
			...
			common.HexToAddress(testconstants.WHPXContractMainnet),
			true,
		},
		{
		...
		},
		{
			...
			common.HexToAddress(testconstants.WHPXContractTestnet),
			true,
		},
		{
