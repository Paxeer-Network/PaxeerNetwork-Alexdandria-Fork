...
const (
	// Amino names
	convertERC20Name = "paxeer/MsgConvertERC20"
	convertCoinName  = "paxeer/MsgConvertCoin" // keep it for backwards compatibility when querying txs
	updateParams     = "paxeer/erc20/MsgUpdateParams"
	registerERC20    = "paxeer/erc20/MsgRegisterERC20"
	toggleConversion = "paxeer/erc20/MsgToggleConversion"
)
