...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/ibc"
...
// registered via governance. Note that the native staking denomination (e.g. "ahpx"),
...
func (k Keeper) ConvertCoinToERC20FromPacket(ctx sdk.Context, data transfertypes.FungibleTokenPacketData) error {
	...
	case pair.IsNativeERC20():
		...
		// assume that all module accounts on Paxeer need to have their tokens in the
