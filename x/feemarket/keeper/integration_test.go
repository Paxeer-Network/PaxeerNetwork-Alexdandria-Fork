...
import (
	...
	"github.com/Paxeer-Network/hyperpaxeer-os/testutil/integration/common/factory"
	...
	fmkttypes "github.com/Paxeer-Network/hyperpaxeer-os/x/feemarket/types"
...
var _ = Describe("Feemarket", func() {
	...
	Describe("Performing Cosmos transactions", func() {
		...
		Context("with min-gas-prices (local) < MinGasPrices (feemarket param)", func() {
			...
			BeforeEach(func() {
				// local min-gas-prices is 10ahpx
