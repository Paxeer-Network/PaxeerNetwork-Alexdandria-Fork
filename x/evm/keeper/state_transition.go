...
import (
	...
	paxcore "github.com/Paxeer-Network/hyperpaxeer-os/x/evm/core/core"
...
// RANDAO implementation. See https://github.com/Paxeer-Network/hyperpaxeer-os/pull/1520#pullrequestreview-1200504697
...
func (k *Keeper) NewEVM(
	...
	blockCtx := vm.BlockContext{
		CanTransfer: paxcore.CanTransfer,
		Transfer:    paxcore.Transfer,
		GetHash:     k.GetHashFn(ctx),
		Coinbase:    cfg.CoinBase,
		GasLimit:    paxtypes.BlockGasLimit(ctx),
	...
	txCtx := paxcore.NewEVMTxContext(msg)
	if tracer == nil {
...
func (k Keeper) GetHashFn(ctx sdk.Context) vm.GetHashFunc {
	return func(height uint64) common.Hash {
		h, err := paxtypes.SafeInt64(height)
		if err != nil {
...
func (k *Keeper) ApplyMessageWithConfig(
	...
	// for more info https://github.com/Paxeer-Network/hyperpaxeer-os/issues/1085
