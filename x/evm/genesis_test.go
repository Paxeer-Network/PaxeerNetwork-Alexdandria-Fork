...
import (
	...
	testfactory "github.com/Paxeer-Network/hyperpaxeer-os/testutil/integration/os/factory"
	testhandler "github.com/Paxeer-Network/hyperpaxeer-os/testutil/integration/os/grpc"
	testkeyring "github.com/Paxeer-Network/hyperpaxeer-os/testutil/integration/os/keyring"
	testnetwork "github.com/Paxeer-Network/hyperpaxeer-os/testutil/integration/os/network"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/evm"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/evm/statedb"
	"github.com/Paxeer-Network/hyperpaxeer-os/x/evm/types"
...
func TestExportGenesis(t *testing.T) {
	...
	require.Len(t, genState.Accounts, 3, "expected 3 smart contracts in the exported genesis") // NOTE: 2 deployed above + 1 for the ahpx denomination ERC-20 pair
	...
	require.Contains(t, genAddresses, testconstants.WHPXContractMainnet, "expected mainnet ahpx contract address in exported genesis")
}
