...
func TestParseChainID(t *testing.T) {
	testCases := []struct {
		...
		{
			"valid chain-id, single digit", "paxeer_1-1", false, big.NewInt(1),
		},
		{
		...
		{
			"invalid chain-id, uppercases", "PAXEER_1-1", true, nil,
		},
		{
			"invalid chain-id, mixed cases", "Paxeer_1-1", true, nil,
		},
		{
			"invalid chain-id, special chars", "$&*#!_1-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot start with 0", "paxeer_001-1", true, nil,
		},
		{
			"invalid eip155 chain-id, cannot invalid base", "paxeer_0x212-1", true, nil,
		},
		{
			"invalid eip155 chain-id, non-integer", "paxeer_paxeer_9000-1", true, nil,
		},
		{
			"invalid epoch, undefined", "paxeer_-", true, nil,
		},
		{
		...
		{
			"long chain-id", "paxeer_" + strings.Repeat("1", 45) + "-1", true, nil,
		},
	}
