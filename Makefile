...
LEDGER_ENABLED ?= true
BINDIR ?= $(GOPATH)/bin
EVMOS_BINARY = hyperpaxd
EVMOS_DIR = hyperpaxeer
BUILDDIR ?= $(CURDIR)/build
HTTPS_GIT := https://github.com/paxeer/hyperpaxeer.git
...
ldflags = -X github.com/cosmos/cosmos-sdk/version.Name=hyperpaxeer \
