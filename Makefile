...
HTTPS_GIT := https://github.com/Paxeer-Network/hyperpaxeer-os.git
...
PACKAGE_NAME:=github.com/Paxeer-Network/hyperpaxeer-os
...
# HyperPaxeer repository and then clean up the contracts data.
...
# Compile the solidity contracts found in the HyperPaxeer repository.
contracts-compile:
...
check-licenses:
	...
	@curl -sSfL https://raw.githubusercontent.com/paxeer/paxeer/v19.0.0/scripts/license_checker/check_licenses.py -o check_licenses.py
